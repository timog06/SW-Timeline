...
fetch("descriptions.json")
  ...
  .then((descriptions) => {
    var items = new vis.DataSet([
      ...
      {
        id: 45,
        content: "Reorganization of the Sith Empire",
        start: new Date(-3640, 1, 1),
        className: "era-change",
      ...
      {
        id: 44,
        content: "Conquest of the Eternal Empire",
        start: new Date(-3636, 1, 1),
        end: new Date(-3631, 12, 31),
        className: "war",
        type: "range",
      ...
      // Major Battles (too short for war)
      {
        id: 36,
  ...
  document.querySelector('.legend-header').addEventListener('click', function() {
    ...
    this.textContent = this.textContent.includes('▼') ? 'Legend ▲' : 'Legend ▼';
  });